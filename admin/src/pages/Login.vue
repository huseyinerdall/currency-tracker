<template>
  <div class="full-screen">
    <b-card style="width:400px;margin:0 auto;">
        <b-card-title class="text-center">para.guru</b-card-title>
        <b-form-group
          label-for="username"
          label="username"
        >
        ...
        <b-form-group
          ...
          label="password"
        >
          <b-form-input v-model="pwd" type="password" @keyup.enter="login"></b-form-input>
        </b-form-group>
