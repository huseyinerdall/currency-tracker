          ...
          <div class="chat-container">
            <div class="conversation">
              <div class="conversation-container">
                ...
                <h3 v-if="data.length == 0" class="text-center text--white" style="color: #fff !important;">İlk yorumu
                  siz yapın.</h3>
                <div v-for="comment in data" :key="comment.id" class="message-cont" style="background: #fff;">
                  <div class="user-info d-flex pa-2 pb-0">
                    ...
                    <v-avatar v-else color="indigo" size="32" class="white--text">{{ comment.fullName | nameAvatar }}
                    </v-avatar>
                    <h4 class="ml-4"
