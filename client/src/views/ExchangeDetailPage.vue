  ...
  <div class="home">
    <v-container class="pa-0 pt-4">
      <v-row class="mt-4">
        <v-col>
          <template>
            <v-card max-width="500" class="mx-auto" color="transparent">
              <v-row class="align-center pl-4">
                <v-avatar size="50">
                  <v-img :src="exchange.image" dark> </v-img>
                </v-avatar>
              ...
              <v-list two-line color="transparent" dark>
                ...
                <v-list-item>
                  ...
                  <v-list-item-content>
                    <v-list-item-title
                      >{{
                        exchange.trade_volume_24h_btc | turkishCurrencyformat
                      }}
                      BTC</v-list-item-title
                    >
                    <v-list-item-subtitle
                      >24 saatlik toplam hacim</v-list-item-subtitle
                    >
                  </v-list-item-content>
                </v-list-item>
                  ...
                  <v-list-item-content>
                    <v-list-item-title>
                      <div class="row pl-2">
                        ...
                        ></v-rating>
                        <span
                          class="grey--text text--lighten-2 text-caption mr-2"
                          >({{ exchange.trust_score / 2 }})</span
                        >
                      </div>
                    </v-list-item-title>
...
export default {
  ...
  metaInfo() {
    return {
      title: "Para.Guru | " + this.$route.params.exchangeid,
      meta: [
        {
          vmid: "description",
          name: "description",
  ...
  created() {
    axios
      .get(`${this.$store.state.api}/borsalar/${this.exchangeid}`)
      .then(response => {
