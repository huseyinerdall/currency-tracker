  ...
  <div class="404">
    <v-container>
      <v-row>
        ...
        >
          <div class="mt-6 display-1 white--text text-center">
            Hesabını Aktif Et
          </div>
          <div class="body-1 mx-auto mt-4 white--text" style="width: 80%;">
            Kayıt olduğunuz eposta adresinize
            <v-chip small>{{ user.email }}</v-chip>
            bir ileti attık ve buradaki bağlantıyı kullanarak hesabını aktif
            hale getirebilirsin.Eğer gelen kutunda görünmüyorsa gereksiz
            klasörünü kontrol edebilirsin.
          </div>
